...
(function() {
  var DEFINE, EMBED, EMBED_DATA, EMPTY_NODE, IFDEF, IFNDEF, INIT_CONTEXT, LINK_AND_EMBED, Linker, MACROS, MODULE, PRECOMPILE, REQUIRE, SCRIPT_FILES, basename, coffee, define, dirname, embed, embedData, existsSync, extname, freplace, fs, globalScope, ifdef, indexIncludes, inspect, isArray, join, jsp, linkAndEmbed, macros, makeDir, makeEnv, nlink, normalize, path, precompile, pro, readFileFromDirSync, relative, removeCoffeeScriptHelpers, removeExt, replaceDefines, replaceFunctions, requires, runMacros, setExt, toplevel, vm, walkSync, _module, _require, _wrapNamespace, _wrapRequireJs,
